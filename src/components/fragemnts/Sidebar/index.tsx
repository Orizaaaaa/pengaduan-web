    ...
    if (role === 'user') {
      ...
      return (
        <>
          ...
          <NavigationList icon={<FaRegNewspaper size={19} />} title="Artikel" pathname="/dashboard-admin/article" />
          <NavigationList icon={<IoMdImages size={19} />} title="Galeri" pathname="/dashboard-admin/galert" />
