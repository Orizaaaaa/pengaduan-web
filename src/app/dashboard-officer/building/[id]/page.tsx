        ...
        <DefaultLayout>
            ...
            {updatePage ?
                ...
                <section className=' bg-white p-4 mx-auto py-10 px-5  rounded-md '>
                    ...
                    <div className="location mt-5">
                        <MapChoise markerPosition={{ lat: form.location.latitude, lng: form.location.longitude }} zoom={13} text={form.address || 'Lokasi Kejadian'} className="h-[300px]  rounded-md mt-4" >
                            <MapEvents />
                        </MapChoise>
                    </div>
